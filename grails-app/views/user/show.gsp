	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.association}">
				<li class="fieldcontain">
					<span id="association-label" class="property-label"><g:message code="user.association.label" default="Association" /></span>
					
						<span class="property-value" aria-labelledby="association-label"><g:link controller="association" action="show" id="${userInstance?.association?.id}">${userInstance?.association?.encodeAsHTML()}</g:link></span>
