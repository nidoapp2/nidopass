...
<head>
	...
	<title>NidoPass | Textos y Traducciones</title>
...
<!-- BEGIN PAGE -->
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">		 
						...
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
								<a href="#">Textos y Traducciones</a> 
							</li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet">
							<div class="portlet-title">
								<div class="caption"><i class="icon-shopping-cart"></i>Textos</div>
								<div class="tools">
							...
							<div class="portlet-body" id="table_texts"></div>
						</div>
				...
				<!-- DESARROLLO -->
				<!--<script>
					$('#table_texts').load('/nidopub-webapp/i18nItem/list', {id_pub:${Pub.findByUri(params.id).id}});
				</script>-->
				<!-- FIN DESARROLLO -->
