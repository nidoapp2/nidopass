...
<!-- BEGIN PAGE -->
		...
		<div id="dialog_features" title="Aviso de versión" class="hide">
			<p>
				Actualmente sólo está operativa la edición de datos de pub: Configuración -> Pub. Estamos trabajando en nuevas funcionalidades que podrás probar muy pronto.
			</p>
			<p>
				Si deseas proponernos mejoras o funciones que consideras intersantes para tu pub, no dudes en comentarnos en el correo: dmv@nidoapp.com
			</p>
		</div>		
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">						  
						...
						<h3 class="page-title">
							Dashboard <small>todo en un vistazo</small>
						</h3>
						<ul class="breadcrumb">
							<li>
				...
				<div id="dashboard">
						...
						<div class="span3 responsive" data-tablet="span6  fix-offset" data-desktop="span3">
							<div class="dashboard-stat purple">
								...
								<div class="details">
									...
									<div class="desc">Popularidad</div>
								</div>
								<a class="more" href="#">
								View more <i class="m-icon-swapright m-icon-white"></i>
								</a>                 
					...
					<div class="row-fluid">
						<div class="span6">
							...
							<div class="portlet solid bordered light-grey">
								<div class="portlet-title">
									<div class="caption"><i class="icon-bar-chart"></i>Comandas</div>
						...
						<div class="span6">
							...
							<div class="portlet solid light-grey bordered">
								<div class="portlet-title">
									<div class="caption"><i class="icon-bullhorn"></i>Entrada de clientes</div>
									<div class="tools">
							...
							<div class="portlet solid bordered light-grey">
								<div class="portlet-title">
									<div class="caption"><i class="icon-signal"></i>Peticiones al sistema</div>
									<div class="tools">
										<div class="btn-group pull-right" data-toggle="buttons-radio">
					...
					<div class="row-fluid">
						<div class="span6">
							<div class="portlet box purple">
								<div class="portlet-title">
									<div class="caption"><i class="icon-calendar"></i>Satisfacción de clientes</div>
									<div class="actions">
									...
									<div class="row-fluid">
										<div class="span4">
											<div class="easy-pie-chart">
												...
												<a class="title" href="#">Tiempos de espera <i class="m-icon-swapright"></i></a>
											</div>
										</div>
										...
										<div class="span4">
											<div class="easy-pie-chart">
												...
												<a class="title" href="#">Calidad producto <i class="m-icon-swapright"></i></a>
											</div>
										</div>
										<div class="margin-bottom-10 visible-phone"></div>
										<div class="span4">
											<div class="easy-pie-chart">
												...
												<a class="title" href="#">Servicio <i class="m-icon-swapright"></i></a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="row-fluid">
						<div class="span6">
							...
							<div class="portlet">
								<div class="portlet-title">
									<div class="caption"><i class="icon-globe"></i>Procedencia de clientes</div>
									<div class="tools">
										<a href="" class="collapse"></a>
										<a href="#portlet-config" data-toggle="modal" class="config"></a>
										<a href="" class="reload"></a>
					...
					<div class="row-fluid">
						...
						<div class="span6">
							...
							<div class="portlet">
								<div class="portlet-title line">
									<div class="caption"><i class="icon-comments"></i>Comentarios de los clientes</div>
									<div class="tools">
										<a href="" class="collapse"></a>
										<a href="#portlet-config" data-toggle="modal" class="config"></a>
										<a href="" class="reload"></a>
								...
								<div class="portlet-body" id="chats">
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										<ul class="chats">
											<li class="in">
												<img class="avatar" alt="" src="${resource(dir: 'images', file: 'avatar1.jpg')}" />
												<div class="message">
											...
											<li class="out">
												<img class="avatar" alt="" src="${resource(dir: 'images', file: 'avatar2.jpg')}" />
												<div class="message">
													<span class="arrow"></span>
											...
											<li class="out">
												<img class="avatar" alt="" src="${resource(dir: 'images', file: 'avatar3.jpg')}" />
												<div class="message">
													<span class="arrow"></span>
