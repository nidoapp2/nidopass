...
<html>
	<head>
		...
		<title>NidoPass | Editar Listado EMails</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">		 
						...
						<h3 class="page-title">
							Editar Listado de EMails
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
								<a href="#">Listado de EMails</a> 
							</li>
						</ul>
				...
				<div class="row-fluid">
					<div class="span12">
						<g:form method="post" >
							...
							<g:hiddenField name="version" value="${EMailsListInstance?.version}" />
							<fieldset class="form">
								<g:render template="form"/>
							</fieldset>
							<fieldset class="buttons">
								<g:actionSubmit class="save btn green" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" />
								<g:actionSubmit class="delete btn red" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" formnovalidate="" onclick="return confirm('${message(code: '¿Seguro que quieres borrar este listado de emails?, esta acción no se podrá deshacer.', default: '¿Seguro que quieres borrar este listado de emails?, esta acción no se podrá deshacer.')}');" />
							</fieldset>
						</g:form>
					</div>
				</div>
