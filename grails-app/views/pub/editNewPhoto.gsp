			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">						
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="${createLink(controller:'pub', action:'editPhotos', params:['id': pub?.uri])}">Editar Fotos</a>
								<i class="icon-angle-right"></i>
							</li>
							<li>
								<a href="#">Nueva Foto</a>
				...
				<div class="row-fluid profile">
					<div class="span12">	
															...
															<g:uploadForm action="saveNewPhoto">
																...
																<div class="fileupload fileupload-new" data-provides="fileupload">
																	<div class="input-append">
																		...
																		<span class="fileupload-new">Selecciona la foto</span>
																...
																<label class="control-label">Descripción de la foto</label>																
																<textarea class="span8 m-wrap" rows="2" name="description"></textarea>
																
																<div class="control-group">
																	<label class="control-label">Imagen principal</label>
																	<div class="controls">
																			<label class="checkbox line">
																				<g:checkBox name="main" value="true" checked="false"/> Establecer como imagen principal
																			</label>																		
																	</div>
																</div>
																...
																<div class="submit-btn">
																	...
																	<a href="${createLink(controller:'pub', action:'editPhotos', params:['id': pub?.uri])}" class="btn">Cancelar</a>
																</div>
															</g:uploadForm>
