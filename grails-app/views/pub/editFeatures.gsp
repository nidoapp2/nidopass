				...
				<div class="row-fluid">
					<div class="span12">						
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">Editar Características</a>
							</li>
						</ul>
				...
				<div class="row-fluid profile">
					<div class="span12">
														<div style="height: auto;" id="accordion1-1" class="accordion collapse">
															<form action="${createLink(controller:'pub', action:'saveFeatures')}" method="post">
																	...
																	<div class="controls">
																		<g:each in="${features}">
																			<label class="checkbox line">
																				<g:checkBox name="selectedFeatures" value="${it.id}" checked="${pub.features.contains(it)}" /> <img src="${createLink(absolute:true, controller:'resources', action: 'pubFeatureImage', params:[repositoryImageId: it.repositoryImageId])}">${it.name}
																			</label>																		
																		</g:each>
																	</div>
																</div>
