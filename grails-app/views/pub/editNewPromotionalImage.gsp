			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">						
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="${createLink(controller:'pub', action:'editPhotos', params:['id': pub?.uri])}">Editar Imágenes Promocionales</a>
								<i class="icon-angle-right"></i>
							</li>
							<li>
								<a href="#">Nueva Imágen Promocional</a>
							</li>
						</ul>
				...
				<div class="row-fluid profile">
					<div class="span12">	
															...
															<g:uploadForm action="saveNewPromotionalImage">
																...
																<div class="fileupload fileupload-new" data-provides="fileupload">
																	<div class="input-append">
																		...
																		<input type="file" class="default" name="photoFile" accept="image/*" required="">
																		</span>
																...
																<calendar:datePicker id="dateFrom" name="dateFrom" dateFormat="%d/%m/%Y" showTime="false" required="" value="${new Date()}" required=""/>
																<label class="control-label">Fecha (Hasta):</label>
																<calendar:datePicker id="dateTo" name="dateTo" dateFormat="%d/%m/%Y" showTime="false" required="" value="${new Date()}" required=""/>
