...
<!-- BEGIN PAGE -->
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<!-- DESARROLLO -->
				<!--<script>
					$('#table_pubs').load('/nidopub-webapp/pub/listAssociationSuperAdmin/${association?.id}');
					$('#table_pubs_no_association').load('/nidopub-webapp/pub/listNoAssociationSuperAdmin/${association?.id}?provinceId=${params.provinceId}');
				</script>-->
				<!-- FIN DESARROLLO -->
