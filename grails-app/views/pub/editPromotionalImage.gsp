			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">						
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="${createLink(controller:'pub', action:'editPromotionalImages', params:['id': pub?.uri])}">Editar Imágenes Promocionales</a>
								<i class="icon-angle-right"></i>
							</li>
							<li>
								<a href="#">Editar Imagen Promocional</a>
							</li>
						</ul>
				...
				<div class="row-fluid profile">
					<div class="span12">	
															...
															<g:uploadForm action="savePromotionalImage">
																<input type="hidden" name="pubUri" value="${pub?.uri}"/>
																<div class="controls">
																	<div class="thumbnail" style="width: 291px; height: 170px;">
																		<img src="${g.createLink(controller:'resources', action: 'pubPromotionalImage', params:[pubUri: pub.uri, imageId: promotionalImage.id, image: promotionalImage.image])}" alt="" style="max-height: 100%;">
																	</div>
																</div>
																...
																<div class="fileupload fileupload-new" data-provides="fileupload">
																	<div class="input-append">
																		...
																		<span class="fileupload-new">Selecciona otra imagen</span>
																...
																<calendar:datePicker id="dateFrom" name="dateFrom" dateFormat="%d/%m/%Y" showTime="false" required="" value="${promotionalImage?.dateFrom}" required=""/>
																<label class="control-label">Fecha (Hasta):</label>
																<calendar:datePicker id="dateTo" name="dateTo" dateFormat="%d/%m/%Y" showTime="false" required="" value="${promotionalImage?.dateTo}" required=""/>
																
																<div class="space10"></div>
																<input type="hidden" name="repositoryImageId" value="${promotionalImage?.image }">
																<div class="submit-btn">
																	<button type="submit" class="btn green">Guardar</button>
																	<a href="${createLink(controller:'pub', action:'editPromotionalImages', params:['id': pub?.uri])}" class="btn">Cancelar</a>
																</div>
															</g:uploadForm>
