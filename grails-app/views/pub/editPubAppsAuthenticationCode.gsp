...
<head>
	...
	<title>NidoPass | Código Sala Acceso Apps</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">						
						...
						<ul class="breadcrumb">
							<li>
								<i class="icon-cogs"></i>
								<a href="#">Administración de Código de Sala para Acceso a Apps</a> 
				...
				<div class="row-fluid profile">
					...
					<div style="height: auto;" id="accordion1-1" class="accordion collapse">
															<form action="${createLink(controller:'pub', action:'savePubAppsAuthenticationCode')}" method="post">
																<input type="hidden" name="pubUri" value="${cmd ? cmd?.pubUri : pub?.uri}"/>
																<table>
																<tr>
																<td><span class="control-label" style="font-size:14px;">Código Acceso Apps </span></td>
																<td><g:textField name="appsAuthenticationCode" placeholder="Ej: 23Ad4gF7" required="" value="${pub.appsAuthenticationCode}"/></td>
																</tr>
																</table>
																<br>
