...
<html>
	<head>
		...
		<title>NidoPass | Administrador Datos Financieros Salas</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">		 
						...
						<h3 class="page-title">
							Administrador Datos Financieros Venta Entradas Online Salas
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
			...
			<table class="table table-striped table-bordered table-advance table-hover">
				...
				<g:each in="${pubInstanceList}" status="i" var="pubInstance">
						...
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							...
							<td><g:link controller="pub" action="editPubFinance" id="${pubInstance.uri}">${fieldValue(bean: pubInstance, field: "name")}</g:link></td>
