...
<head>
	...
	<title>NidoPass | Datos TPV Sala</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">						
						...
						<ul class="breadcrumb">
							<li>
								<i class="icon-cogs"></i>
								<a href="#">Administración de Datos Configuración TPV de Sala</a> 
				...
				<div class="row-fluid profile">
					...
					<div style="height: auto;" id="accordion1-1" class="accordion collapse">
															<form action="${createLink(controller:'pub', action:'savePubTPVConfig')}" method="post">
																<input type="hidden" name="pubUri" value="${cmd ? cmd?.pubUri : pub?.uri}"/>
																<table>
																<tr>
																<td><span class="control-label" style="font-size:14px;">Clave de Encriptación </span></td>
																<td><g:textField name="encryptionKey" required="" value="${pub.encryptionKey}"/></td>
																</tr><tr>
																<td><span class="control-label" style="font-size:14px;">Código Comercio </span></td>
																<td><g:textField name="merchantId" required="" value="${pub.merchantId}"/></td>
																</tr><tr>
																<td><span class="control-label" style="font-size:14px;">Código Entidad </span></td>
																<td><g:textField name="acquirerBIN" required="" value="${pub.acquirerBIN}"/></td>
																</tr><tr>
																<td><span class="control-label" style="font-size:14px;">Terminal </span></td>
																<td><g:textField name="terminalId" required="" value="${pub.terminalId}"/></td>
																</tr>
																</table>
																<br>
