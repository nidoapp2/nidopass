			...
			<table class="table table-striped table-bordered table-advance table-hover">
				...
				<g:each in="${pubInstanceList}" status="i" var="pubInstance">
						...
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							...
							<td><g:link controller="association" action="addPubSuperAdmin" params="[associationId: association?.id]" id="${pubInstance.id}"><i class="icon-create-style icon-plus-sign"></i></g:link></td>
