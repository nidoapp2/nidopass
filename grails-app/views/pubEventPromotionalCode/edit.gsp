...
<html>
	<head>
		...
		<title>NidoPass | Editar Código Promocional Evento</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">		 
						...
						<h3 class="page-title">
							Editar Código Promocional de Evento
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
				...
				<div class="row-fluid">
					<div class="span12">
						<g:uploadForm method="post" >
							...
							<g:hiddenField name="version" value="${pubEventPromotionalCodeInstance?.version}" />
							...
							<fieldset class="buttons">
								...
								<g:actionSubmit class="delete btn red" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" formnovalidate="" onclick="return confirm('${message(code: '¿Seguro que quieres borrar este código promocional?, esta acción no se podrá deshacer.', default: '¿Seguro que quieres borrar este código promocional?, esta acción no se podrá deshacer.')}');" />
							</fieldset>
						</g:uploadForm>
						<span style="color:red;">IMPORTANTE: El descuento se aplicará al precio TOTAL de la compra.</span>
					</div>
				</div>
