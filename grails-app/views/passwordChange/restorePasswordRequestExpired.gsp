...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" >
	<meta charset="utf-8" />
	<title>Tu petición de cambio de contraseña ha expirado</title>
...
<body class="login">
	...
	<div class="content">
		...
		<!-- BEGIN LOGIN FORM -->
		<h3 class="form-title">Tu petición ha expirado</h3>
		<p>Tu petición de cambio de contraseña ha expirado. Puedes volver a solicitarla desde la ventana de acceso</p>  
		<div class="form-actions"> 
			<a href="${createLink(controller:'home')}" class="btn green" role="button">Ir a ventana de acceso</a>
		</div> 
