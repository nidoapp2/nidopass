...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Problema de notificación de cancelación al pub</title>
		<style type="text/css">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Problema de notificación de cancelación al pub</h2>
									<br />
									<div class="textdark">
										<p>
										Hola,
										...
										<p>
										Ha sido imposible notificar al pub la cancelación de reserva para ${reservation?.pub?.name} (${reservation?.pub?.id}):									
										</p>
										<p>
