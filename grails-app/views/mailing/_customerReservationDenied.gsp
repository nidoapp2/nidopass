...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Reserva Denegada</title>
		<style type="text/css">
							...
							<tr>
								<td valign="top" style="padding:20px;">
									...
									<div class="textdark">
										...
										<p>
										Sentimos informarte de que tu reserva en ${reservation?.pub?.name} ha sido DENEGADA. 										
										</p>
										<br/>
										<p>
										Te recomendamos que te pongas en contacto con el pub:
										</p>
										 <p>
										Teléfono:  ${reservation?.pub?.telephone}
										</p>
										<p>
										Email:  ${reservation?.pub?.email} 
										</p>
