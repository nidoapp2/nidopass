...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Comentarios de nueva solicitud de reserva</title>
		<style type="text/css">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Comentarios de nueva solicitud de reserva</h2>
									<br />
									<div class="textdark">
										<p>
										Hola,
										...
										<p>
										La solicitud de reserva para ${reservation?.pub?.name} el  ${reservation?.reservationDate?.format('dd/MM/yyyy')} a las ${reservation?.reservationDate?.format('HH:mm')} a nombre de ${reservation?.customer?.name} incluye el siguiente comentario:
										</p>
										<p>
