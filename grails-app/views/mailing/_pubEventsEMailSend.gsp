...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Nuevos Eventos ${eventsEMailList?.pub?.name}</title>
		<style type="text/css">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Nuevos Eventos ${eventsEMailList?.pub?.name}</h2>
									<br />
									<div class="textdark">
										<p>
										Hola,
										...
										<p>
										Estos son los próximos eventos en ${eventsEMailList?.pub?.name}:										</p>
										<p>
										<table>
											<thead>
												<th>Título</th>
												...
												<th>Artista</th>
												<th>Fecha</th>
												<th>Acepta Menores</th>
												<th>Web Evento</th>
												<th>Precio</th>
											</thead>
											<tbody>
												<g:each in="${eventsEMailList.events}" var="event">
													<tr>
														<td>${event.title}</td>
														...
														<td>${event.url}</td>
														<td>${event.price+event.commission}€</td>
													</tr>
												</g:each>
											</tbody>
										</table>
