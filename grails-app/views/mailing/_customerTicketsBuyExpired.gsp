...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | ${ticketsSold?.pubEvent?.pub?.name } - Compra de entrada/s NO realizada - Evento ${ticketsSold?.pubEvent?.title}</title>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Compra de entrada/s NO realizada - Evento ${ticketsSold?.pubEvent?.title}</h2>
									<br />
									<div class="textdark">
										<p>
										Hola,
										...
										<p>
										No se ha podido realizar la compra de la/s entrada/s para el evento ${ticketsSold?.pubEvent?.title} del día ${String.format( '%02d', ticketsSold?.pubEvent?.dateEvent.getDate())+"/"+String.format( '%02d', (ticketsSold?.pubEvent?.dateEvent.getMonth()+1))+"/"+(ticketsSold?.pubEvent?.dateEvent.getYear()+1900)} a las ${String.format( '%02d', ticketsSold?.pubEvent?.dateEvent.getHours())+":"+String.format( '%02d', ticketsSold?.pubEvent?.dateEvent.getMinutes())}.
										</p>
										
										<p>Para más información contacte con la sala al teléfono ${ticketsSold?.pubEvent?.pub?.telephone} o al email ${ticketsSold?.pubEvent?.pub?.email}.</p>
