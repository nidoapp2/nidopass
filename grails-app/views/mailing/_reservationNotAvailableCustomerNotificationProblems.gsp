...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Problema de notificación de reserva no dispobible por cierre del pub ese día al cliente</title>
		<style type="text/css">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Problema de notificación de reserva no disponible por cierre del pub ese día al cliente</h2>
									<br />
									<div class="textdark">
										<p>
										Hola,
										...
										<p>
										Ha sido imposible notificar al cliente ${reservationRequest?.customerName}, que su reserva en ${Pub.findById(reservationRequest?.pubId).name}, no se ha podido realizar, por cierre del pub ese día.									
										</p>
										<p>
