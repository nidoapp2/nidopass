...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | ${appsAuthenticationCode?.pub?.name } - Código acceso apps</title>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Código de Acceso para Apps.</h2>
									<br />
									<div class="textdark" style="font-size:18px;">
										...
										<p>
										Introduzca el código de acceso facilitado en este email, cuando se le solicite al abrir la aplicación móvil.
										</p>
										
										<h3><b>Código Acceso: ${appsAuthenticationCode?.code }</b></h3>
