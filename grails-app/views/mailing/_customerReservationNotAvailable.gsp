...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Reserva No Diponible para el día seleccionado.</title>
		<style type="text/css">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Reserva No Disponible para el día seleccionado</h2>
									<br />
									<div class="textdark">
										<p>
										Hola ${reservationRequest?.customerName},
										</p>
										<p>
										Tu reserva en ${Pub.findById(reservationRequest?.pubId).name} no se ha podido realizar, ya que el pub está cerrado ese día y a esa hora. Puede contactar por teléfono con el pub si lo desea en el número ${Pub.findById(reservationRequest?.pubId).telephone}.</p>
										<p>Datos reserva solicitada:</p>
										<p>
										Fecha:  ${reservationRequest?.reservationDate?.format('dd/MM/yyyy')}
										</p>
										 <p>
										Hora:  ${reservationRequest?.reservationDate?.format('HH:mm')}
										</p>
										<p>
										Comensales: ${reservationRequest?.adults} adultos, ${reservationRequest?.children} niños 
										</p>
										<p>
										Nombre:  ${reservationRequest?.customerName}
										</p>
										<p>
										Teléfono:  ${reservationRequest?.customerPhone}
										</p>
										<p>
										Email:  ${reservationRequest?.customerEmail}
										</p>								
