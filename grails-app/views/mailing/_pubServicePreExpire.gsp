...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Servicio de ${service } caduca en 15 días para la sala ${pub?.name }</title>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Servicio de ${service } caduca en 15 días para la sala ${pub?.name }</h2>
									<br />
									<div class="textdark">
										<p>
										Hola,
										...
										<p>
										Le informamos de que el servicio de ${service } para la sala ${pub?.name } caducará en 15 días.
										</p>
										
										<p>Para más información o ampliar la duración del servicio, contacte en dmv@nidoapp.com.</p>
