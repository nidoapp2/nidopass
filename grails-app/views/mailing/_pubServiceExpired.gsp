...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Servicio de ${service } deshabilitado a sala ${pub?.name }</title>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Servicio de ${service } deshabilitado a sala ${pub?.name }</h2>
									<br />
									<div class="textdark">
										<p>
										Hola,
										...
										<p>
										Se ha deshabilitado el servicio de ${service } a la sala ${pub?.name }, porque ha caducado la contratación de este.
										</p>
										
										<p>Para más información contacte en dmv@nidoapp.com.</p>
