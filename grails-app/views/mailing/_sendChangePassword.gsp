...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Cambio de contraseña</title>
		<style type="text/css">
							...
							<tr>
								<td valign="top" style="padding:20px;">
									...
									<div class="textdark">
										...
										<p>
										Hemos recibido una solicitud para cambiar tu contraseña. Para continuar con el proceso, accede al siguiente enlace:
										</p>
										<br/>
										<a href="${createLink(absolute: true, controller:'passwordChange', action:'showRestorePassword', id: passwordChange.urlIdentifier)}">${createLink(absolute: true, controller:'passwordChange', action:'showRestorePassword', id: passwordChange.urlIdentifier)}</a>

																	
										<br/><br/>
										
										<p>
										Si no has solicitado cambio de contraseña, simplemente obvia este mensaje.										
										</p>	
										<br/><br/>																			
