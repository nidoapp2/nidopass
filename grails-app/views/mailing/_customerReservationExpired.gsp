...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Solicitud de Reserva sin respuesta</title>
		<style type="text/css">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Solicitud de Reserva sin respuesta</h2>
									<br />
									<div class="textdark">
										<p>
										...
										<p>
										Tu solicitud de reserva en ${reservation?.pub?.name} NO HA OBTENIDO RESPUESTA.</p>
										<p>
										Te recomendamos que te pongas en contacto con el pub para realizar la reserva telefónica en el siguiente número:  ${reservation?.pub?.telephone}
										</p>
										<p>
