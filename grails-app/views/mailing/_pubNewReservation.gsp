...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Nueva solicitud de reserva</title>
		<style type="text/css">
							...
							<tr>
								<td valign="top" style="padding:20px;">
									...
									<div class="textdark">
										...
										<p>
										Han recibido la siguiente solicitud de reserva para ${reservation?.pub?.name}:									</p>
										<p>
										...
										<br/>
										<p>
										Por favor, confirme o deniegue la reserva tan pronto como sea posible:
										</p>										
										
										<a href="${createLink(absolute:true, controller:'reservationResolution', action:'confirm', params:['id': reservation?.externalId, 'key': apiKey])}" target="_blank" class="btn green">CONFIRMAR</a> 
										<br/>
										<br/>
										
										<a href="${createLink(absolute:true, controller:'reservationResolution', action:'deny', params:['id': reservation?.externalId, 'key': apiKey])}" target="_blank" class="btn red">DENEGAR</a> 
										<br/><br/>
