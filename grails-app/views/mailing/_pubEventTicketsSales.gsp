...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | Ventas de Entradas: ${pubEvent?.title }</title>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td valign="top" style="padding:20px;">
									<h2>Venta de Entradas: ${pubEvent?.title }</h2>
									<br />
									<div class="textdark">
										<p>
										Hola,
										...
										<p>
										Se ha cerrado la venta de entradas de ${pubEvent?.title }, puede ver un listado de todas las ventas realizadas en el documento excel adjunto.
										</p>
