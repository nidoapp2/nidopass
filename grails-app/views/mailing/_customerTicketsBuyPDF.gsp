...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NidoPass | ${ticketsSold?.pubEvent?.pub?.name } - Entrada/s ${ticketsSold?.pubEvent?.title.replaceAll('&', '&amp;')}</title>
													...
													<center> 
														...
														<table style="width:600px; padding:20px 50px 20px 50px !important; border:2px dashed black;"> 
															<tr>
																...
																<td style="font-size:10px; text-align:left !important; background:black; color:white;">FECHA:</td><td  style="font-size:10px; text-align:left !important; background:#d0d0d0; color:black; width:80px;"><b>${String.format( '%02d', ticketsSold?.pubEvent?.dateEvent.getDate())+"/"+String.format( '%02d', (ticketsSold?.pubEvent?.dateEvent.getMonth()+1))+"/"+(ticketsSold?.pubEvent?.dateEvent.getYear()+1900)}</b></td>
																<td style="font-size:10px; text-align:left !important; background:black; color:white;">HORA:</td><td style="font-size:10px; text-align:left !important; background:#d0d0d0; color:black; width:80px;"><b>${String.format( '%02d', ticketsSold?.pubEvent?.dateEvent.getHours())+":"+String.format( '%02d', ticketsSold?.pubEvent?.dateEvent.getMinutes())}</b></td>
															</tr><tr><td style="height:5px;" colspan="4"></td></tr><tr>
