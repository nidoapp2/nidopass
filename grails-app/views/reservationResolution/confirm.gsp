...
<body class="login">
	...
	<div class="content">
		...
		<g:if test="${processed}">		
			<h3 class="form-title">Reserva Confirmada</h3>	
			<p>La reserva ha sido confirmada correctamente.</p>		
		</g:if>
		<g:elseif test="${reservation.STATUS_CONFIRMED ==  reservation.status}">
			<h3 class="form-title">Reserva ya confirmada previamente</h3>	
			<p>No se ha realizado confirmación. La reserva había sido confirmada previamente.</p>		
		</g:elseif>
		<g:elseif test="${reservation.STATUS_DENIED ==  reservation.status}">
			<h3 class="form-title">Reserva ya denegada previamente</h3>	
			<p>No se ha realizado confirmación. La reserva había sido denegada previamente.</p>		
		</g:elseif>
		<g:elseif test="${reservation.STATUS_CANCELLED ==  reservation.status}">
			<h3 class="form-title">Reserva ya cancelada previamente</h3>	
			<p>No se ha realizado confirmación. La reserva había sido cancelada previamente.</p>		
		</g:elseif>
		<g:elseif test="${reservation.STATUS_EXPIRED ==  reservation.status}">
			<h3 class="form-title">Reserva ya expirada</h3>	
			<p>No se ha realizado confirmación. La reserva ha expirado.</p>		
		</g:elseif>
